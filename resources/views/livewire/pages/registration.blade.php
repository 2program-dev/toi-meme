    ...
    <x-utilities.section class="w-full">
        ...
        <div class="mt-8 lg:mt-12">
            <x-utilities.container size="xsmall">
                <form wire:submit.prevent="register" class="flex flex-col gap-8 lg:gap-16 w-full">
                ...
                <div class="text-center mt-2">
                    Sei già registrato? Vai alla pagina di <a href="/login"
                        class="text-orange hover:underline"><b>login</b></a>
                </div>
            </x-utilities.container>
        </div>
    </x-utilities.section>
